...
class App extends React.Component {
  ...
  addMovieToWillWatch = movie => {
    // this.state.moviesWillWatch.push(movie); const updateMoviesWillWatch =
    // [...this.state.moviesWillWatch]; updateMoviesWillWatch.push(movie);

    const updateMoviesWillWatch = [
      ...
      <div >
        ...
        <div className="container">
          <div className="row mb-4 mt-4">
            ...
            <div className="col-3">
              <h2 className="mb-4">Will Watch: {this.state.moviesWillWatch.length}
                </h2>
